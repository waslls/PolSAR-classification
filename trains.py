...
def main():
    ...
    parser.add_argument('--feature_folder', type=str,default='../data/features_san23')  # './features_124'、'./features_23'
    parser.add_argument('--label_folder', type=str, default=r'../data/label_s.png')
